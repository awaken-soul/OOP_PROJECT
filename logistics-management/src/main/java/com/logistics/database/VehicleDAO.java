...
public class VehicleDAO {
    ...
    public void initializeTestVehicles() {
        ...
        try (Connection conn = DBConnector.getConnection();
            ...
            // Vehicle 2: Unassigned, Status: Maintenance
            pstmt.setInt(1, 2);
            pstmt.setString(2, "Bike");
            pstmt.setString(3, "BI-002");
            pstmt.setString(4, "Maintenance");
            pstmt.setNull(5, Types.INTEGER); 
            pstmt.setString(6, "Maintenance Bay");
            pstmt.executeUpdate();

            System.out.println("VehicleDAO: Test vehicles injected successfully.");
    ...
    public Vehicle getVehicleById(int vehicleId) {
        ...
        try (Connection conn = DBConnector.getConnection();
            ...
            System.err.println("Database error retrieving single vehicle: " + e.getMessage());
        }
        return null;
    }
