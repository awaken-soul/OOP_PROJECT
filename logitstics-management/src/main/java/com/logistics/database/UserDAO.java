...
public class UserDAO {
    ...
    public void initializeTestUsers() {
        ...
        registerTestUser(100, "Admin Root", "admin@logistics.com", TEST_PASSWORD, "Admin", "9990001111", "HQ - City Center", 1);
        registerTestUser(101, "Alice Customer", "alice@customer.com", TEST_PASSWORD, "Customer", "9876543210", "123 Main St", 1);
        registerTestUser(102, "Bob Agent", "bob@agent.com", TEST_PASSWORD, "Agent", "7775553333", "456 North St", 1);
        registerTestUser(103, "Charlie Manager", "charlie@wh.com", TEST_PASSWORD, "Manager", "6664442222", "Warehouse 1 Depot", 1);
    ...
    private boolean registerTestUser(int id, String name, String email, String password, String role, String contact, String address, int is_validated) {
        String sql = "INSERT INTO User (user_id, name, email, password, role, contact_number, address, is_validated) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public boolean registerNewUser(User user, String plainPassword) {
        String sql = "INSERT INTO User (name, email, password, role, contact_number, address, is_validated) VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection conn = DBConnector.getConnection();
            ...
            pstmt.setInt(7, 0); // New user is initially NOT validated
    ...
    public List<DeliveryAgent> getAvailableAgents() {
        ...
        // Only return agents who are VALIDATED (is_validated = 1)
        String sql = "SELECT * FROM User WHERE role = 'Agent' AND is_validated = 1"; 
    ...
    // --- Vendor/Agent Validation Method (for AdminService) ---
