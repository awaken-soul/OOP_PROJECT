...
public class DBConnector {
    ...
    public static void createTables() {
        try (Connection conn = getConnection(); 
            ...
            // 1. User Table (Includes is_validated for Admin monitoring)
            String sqlUser = "CREATE TABLE IF NOT EXISTS User (" +
                             ...
                             "contact_number TEXT," +
                             "address TEXT," +
                             "is_validated INTEGER DEFAULT 1" + // 1 for approved, 0 for pending
                             ");";
            stmt.execute(sqlUser);
            
            // 2. Retailer Table (Simple Vendor Table)
            ...
            String sqlVehicle = "CREATE TABLE IF NOT EXISTS Vehicle (" +
                                ...
                                "status TEXT NOT NULL," + // Available, On Delivery, Maintenance
                                "driver_id INTEGER," +
            ...
            System.out.println("✅ Database schema initialized. All tables created successfully.");
